// Builds and returns the Express app WITHOUT starting the server or any
// background jobs. Split out of index.js so it can be imported directly in
// tests (via supertest) without opening a real network port or kicking off
// cron-based reminder jobs as a side effect of require().
